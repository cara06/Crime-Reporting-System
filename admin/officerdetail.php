  ...
  <div class="clear">
          ...
          <div class="corner-bottom-left">
            <div class="corner-bottom-right">
              <form action="chkOfficerdetail.php" method="post" enctype="multipart/form-data" name="form1">
                <div>
                  <h2><span class="componentheading style6"> <span class="style10">Information about Officer:</span></span></h2>
                </div>
                <p>&nbsp;</p>
                <table width="770" height="560" border="0" align="center" cellpadding="10" cellspacing="5">
                  <tr>
	...
	<td height="2" colspan="8" ></td>
                  ...
                  <tr>
				   ...
				   // " It allows only characters"});
                    ...
                    <td width="74" align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">City:</span></td>
	...
	<td height="4" colspan="8" ></td>
                  ...
                  <tr bgcolor="#993366">
                    ...
                    <td colspan="3" align="left" bgcolor="#FFFFFF"><input name="emailid" type="text" id="emailid" size="35" maxlength="254" />
                        <script type="text/javascript">
	...
	<td height="4" colspan="8" ></td>
                  ...
                  <tr bgcolor="#993366">
                    ...
                    <td colspan="3" align="left" bgcolor="#FFFFFF"><input type="text" name="jdate" id="jdate" /></td>
                  </tr>
				   <tr>
	<td height="4" colspan="8" ></td>
</tr>
                  <tr bgcolor="#993366">
                    ...
                    <td colspan="3" align="left" bgcolor="#FFFFFF"><input type="text" name="ldate" id="ldate" /></td>
                  </tr>
				   <tr>
	<td height="5" colspan="8" ></td>
</tr>
                    ...
                    <td colspan="3" align="left" bgcolor="#FFFFFF"><span class="style15 style3">
                      <select name="psname" size="1"  id="psname" >
                        <?php
						  ...
						  {
						  ?>
                        <option value="<?php echo $rowPs['policestation_id']?>"> <?php echo $rowPs['policestation_name']?></option>
                        <?php }?>
                        <script type="text/javascript">
	...
	<td height="5" colspan="8" ></td>
                  ...
                  <tr bgcolor="#993366">
                    <td align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">Designation Name:</span> </td>
                    <td colspan="3" align="left" bgcolor="#FFFFFF"><span class="style15 style3">
	...
	<td height="5" colspan="8" ></td>
                ...
                <p>&nbsp;</p>
                <div>
                  <h2>&nbsp;&nbsp;<span class="style21">Log in information:</span></h2>
                </div>
                <p>&nbsp;</p>
                <table width="643" cellpadding="10" cellspacing="20">
                  <tr bgcolor="#993366">
                    <td align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">Choose login name:</span> </td>
                    <td width="424" align="left" bgcolor="#FFFFFF"><span class="style15">
                      <label>
                  ...
                  <tr bgcolor="#999999">
                    <td align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">Password: </span> </td>
                  ...
                  <tr bgcolor="#993366">
                    <td height="22" align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">Re-Type Password: </span> </td>
                    <td align="left" bgcolor="#FFFFFF"><span class="style15">
