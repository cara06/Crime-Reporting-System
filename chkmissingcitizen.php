...
if(move_uploaded_file($_FILES['photo']['tmp_name'],$photo))  
 {
    $insertQuery = "insert into mstr_missingcitizens(first_name,middle_name,last_name,date,time,gender,address,
	                                         contact_no,description,special_clue,email_id,username,city_id,area_id,photo) 
		                              values ('".$firstname."','".$middlename."','".$lastname."','".$date."',
									          '".$time2."','".$gender."','".$address."','".$missingdesc."',
											  '".$specialclue."','".$_SESSION['username']."','".$city."',
											  '".$areaname."','".$photo."')";
	...
	//echo "$insertQuery";
	  if(mysql_query($insertQuery))
	  {
	   ...
	   {
		header("location:missing_citizen.php?msg=You are not Registered");
	    }
  }
else
{
